...
class AppSettings(BaseSettings):
    ...
    config_path: str = '/etc/netmin/config.yml'
    ...
    db_path: str | None = '/var/lib/netmin/netmin.db'
    db_port: int = 0
    ...
    site_description: str = 'A network access controller designed for freeRADIUS.'
    site_email: str = 'netmin@yourdomain.com'
    site_from_email: str = 'netmin@yourdomain.com'
    site_logo: str | None = None
    site_title: str = 'Netmin'
    site_url: str = 'https://netmin.yourdomain.com'
...
def load_settings(env_file_path: str = '/etc/netmin/.env', env_file_encoding: str = 'UTF-8',
    ...
    os.putenv('NETMIN_ENV_FILE', env_file_path)
    os.putenv('NETMIN_ENV_FILE_ENCODING', env_file_encoding)
    ...
    if secrets_path is not None:
        ...
        if valid:
            ...
            os.putenv('NETMIN_ENV_SECRETS_DIR', secrets_path)
...
env_conf_path: str = os.getenv('NETMIN_ENV_FILE', '/etc/netmin/.env')
